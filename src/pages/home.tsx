...
import { MonacoReact } from "@/components/monaco-react.jsx";
...
export function Home() {
  ...
  const [codeEditor, setEditor] = useState<editor.IStandaloneCodeEditor>();

  useEffect(() => {
    editor.setTheme(resolvedTheme === "dark" ? "vs-dark" : "vs");
  }, [resolvedTheme]);
                        ...
                        onSelect={(currentValue) => {
                          ...
                          if (codeEditor) {
                            editor.setModelLanguage(
                              codeEditor.getModel() as ITextModel,
                              currentValue
                            );
                            codeEditor.setValue(code_snippets[currentValue]);
                          }
                          setOpen(false);
                        }}
                      >
        ...
        <ResizablePanelGroup direction={orientation} className="flex-1">
          <ResizablePanel>
            {/* <CodeEditor
              ...
              setEditor={setEditor}
            /> */}
            <MonacoReact defaultCode={code_snippets["go"]} />
          </ResizablePanel>
